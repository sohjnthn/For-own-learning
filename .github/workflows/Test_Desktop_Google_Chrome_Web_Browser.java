...
public class Test {
    ...
    public void testMethod1() throws IOException {
        ...
        driver2.get("https://aminoapps.com/c/maplestorysea/home/");
        ...
        WebElement aminoSearchBar = driver2.findElement(By.className("nav-search-input"));
        ...
        //websiteTitle = driver2.getTitle();
        List <WebElement> tagNameH3WebElementList = driver2.findElements(By.tagName("h3"));
        ...
        WebElement privacyNoticeAcceptButton = driver2.findElement(By.className("confirm-close"));
        ...
        WebElement freeCharacterSlotExpansionCoupon = driver2.findElement(By.className("overflow-hidden"));
        ...
        List<WebElement> fourOverflowHiddenClassnameWebElementList = driver2.findElements(By.className("overflow-hidden"));
        ...
        // Base this on the Inspect - Ctrl+F order or position, search with "" marks
        // className for this case is "overflow-hidden"
        List<WebElement> sevenLabelClassnameWebElementList = driver2.findElements(By.className("label"));
        // Spell Trace and Star Force Enhancement
    ...
    public void testMethod2 () throws IOException {
        ...
        driver2.get("https://aminoapps.com/c/maplestorysea/recent/");
        capturedScreenshotImageFilepathString = takeScreenshot(driver2);
    ...
    public void testMethod3 () throws IOException {
        // An error was caused as driver2 for the Given method cannot be brought to the Then method
        ...
        List<WebElement> tagNameIWebElementList = driver2.findElements(By.tagName("i"));
        ...
        List<WebElement> tagNameButtonWebElementList = driver2.findElements(By.tagName("button"));
        ...
        WebElement tagLine = driver2.findElement(By.className("tagline"));
        ...
        // tagName is "p"
        List <WebElement> tagNamePWebElementList = driver2.findElements(By.tagName("p"));

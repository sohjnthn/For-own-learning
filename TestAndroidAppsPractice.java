...
@CucumberOptions(
        features = "src/test/resources/features/For_Manual_Practice_Real_Android_15_Smartphone_Applications.feature",
        glue = {"src/test/java/formanualpractice/"},
        plugin = {"pretty", "html:target/cucumber-reports"}
)
public class TestAndroidAppsPractice {
    ...
    FirstAndroidAppPractice firstAndroidAppPractice;

    SecondAndroidAppPractice secondAndroidAppPractice;

    ThirdAndroidAppPractice thirdAndroidAppPractice;

    public TestAndroidAppsPractice() throws IOException {
    }

    @org.junit.Test
    @org.junit.jupiter.api.Test
    @org.testng.annotations.Test
    @Given("that I should use xpath for the Appium Inspector weblink")
    public void testMethod1() throws IOException {
        ...
        desiredCapabilities.setCapability("appium:app", "C:\\Users\\sohjnthn\\IdeaProjects\\For_Manual_Practice\\app\\com.afwsamples.testdpc_9.0.12-9012_minAPI21(nodpi)_apkmirror.com.apk");
        desiredCapabilities.setCapability("appium:automationName", "UiAutomator2");
        driver1 = new AndroidDriver(new URL("http://127.0.0.1:4723/wd/hub"), desiredCapabilities);

        firstAndroidAppPractice = new FirstAndroidAppPractice(driver1, extentTest, extentSparkReporter, extentReport);
    }

    @org.junit.Test
    @org.junit.jupiter.api.Test
    @org.testng.annotations.Test
    @When("I have done so for AndroidDriver")
    ...
    @org.junit.jupiter.api.Test
    @org.testng.annotations.Test
    @Then("I should be able to find, or click on such mobile WebElements")
    public void testMethod3 () throws IOException {
        DesiredCapabilities desiredCapabilities = new DesiredCapabilities();
        desiredCapabilities.setCapability("platformName", "Android");
        desiredCapabilities.setCapability("appium:platformVersion", "15.0");
        desiredCapabilities.setCapability("appium:app", "C:\\Users\\sohjnthn\\IdeaProjects\\For_Manual_Practice\\app\\ApiDemos-debug.apk");
        desiredCapabilities.setCapability("appium:automationName", "UiAutomator2");
        driver2 = new AndroidDriver(new URL("http://127.0.0.1:4723/wd/hub"), desiredCapabilities);

        secondAndroidAppPractice = new SecondAndroidAppPractice(driver2, extentTest, extentSparkReporter, extentReport);

        desiredCapabilities = new DesiredCapabilities();
        desiredCapabilities.setCapability("platformName", "Android");
        desiredCapabilities.setCapability("appium:platformVersion", "15.0");
        desiredCapabilities.setCapability("appium:app", "C:\\Users\\sohjnthn\\IdeaProjects\\For_Manual_Practice\\app\\com.microsoft.emmx.canary_138.0.3336.0-333600000_minAPI26(armeabi-v7a)(nodpi)_apkmirror.com.apk");
        desiredCapabilities.setCapability("appium:automationName", "UiAutomator2");
        driver3 = new AndroidDriver(new URL("http://127.0.0.1:4723/wd/hub"), desiredCapabilities);

        thirdAndroidAppPractice = new ThirdAndroidAppPractice(driver3, extentTest, extentSparkReporter, extentReport);
    }

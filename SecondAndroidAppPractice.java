...
public class SecondAndroidAppPractice {

    String capturedScreenshotImageFilepathString = "";
    public SecondAndroidAppPractice(AndroidDriver driver, ExtentTest extentTest, ExtentSparkReporter extentSparkReporter, ExtentReports extentReport) {
    }

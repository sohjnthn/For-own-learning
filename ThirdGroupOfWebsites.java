    ...
    public ThirdGroupOfWebsites (ChromeDriver driver, ExtentTest extentTest, ExtentSparkReporter extentSparkReporter, ExtentReports extentReport) throws IOException {
        ...
        for(int i=0; i<10; i++) {
            ...
            if (topLeftCornerAminoLogoButton.isDisplayed()) {
                extentTest.addScreenCaptureFromPath(capturedScreenshotImageFilepathString).pass(MediaEntityBuilder.createScreenCaptureFromPath(capturedScreenshotImageFilepathString).build()).log(Status.PASS, "The Amino webpage's tagline text is displayed as the correct \"" + "Explore your interests and find your communities." + "\"; which should be \"Explore your interests and find your communities.\", the pop-up UI would take time to load.");
            } else {
                extentTest.addScreenCaptureFromPath(capturedScreenshotImageFilepathString).pass(MediaEntityBuilder.createScreenCaptureFromPath(capturedScreenshotImageFilepathString).build()).log(Status.FAIL, "The Amino webpage's tagline text is displayed as the incorrect \"" + "Explore your interests and find your communities." + "\"; which should be \"Explore your interests and find your communities.\", the pop-up UI would take time to load.");
            }
        }
        ...
        capturedScreenshotImageFilepathString = takeScreenshot(driver);
        if(Objects.equals(exploreYourInterestsAndFindYourCommunitiesFullstopTextString, "Explore your interests and find your communities.")){
            extentTest.addScreenCaptureFromPath(capturedScreenshotImageFilepathString).pass(MediaEntityBuilder.createScreenCaptureFromPath(capturedScreenshotImageFilepathString).build()).log(Status.PASS, "The pop-up's text is the correct " + "\"" + exploreYourInterestsAndFindYourCommunitiesFullstopTextString + "\"; and should be \"Explore your interests and find your communities.\".");
        } else {
            extentTest.addScreenCaptureFromPath(capturedScreenshotImageFilepathString).pass(MediaEntityBuilder.createScreenCaptureFromPath(capturedScreenshotImageFilepathString).build()).log(Status.PASS, "The pop-up's text is the incorrect " + "\"" + exploreYourInterestsAndFindYourCommunitiesFullstopTextString + "\"; and should be \"Explore your interests and find your communities.\".");
        }

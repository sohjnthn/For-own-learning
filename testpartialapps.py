...
if prefillQueryTextField.is_displayed():
 screenshots["The Prefill Query Text Field is displayed."] = take_screenshot(driver3, "The Prefill Query Text Field is displayed.")
else:
 screenshots["The Prefill Query Text Field is not displayed."] = take_screenshot(driver3, "The Prefill Query Text Field is not displayed.")

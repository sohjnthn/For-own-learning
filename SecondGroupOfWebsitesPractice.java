...
public class SecondGroupOfWebsitesPractice {

    String capturedScreenshotImageFilepathString = "";
    public SecondGroupOfWebsitesPractice(ChromeDriver driver, ExtentTest extentTest, ExtentSparkReporter extentSparkReporter, ExtentReports extentReport) {
    }

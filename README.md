...
Run the main Python file ("testparitialwebsites.py"; if not "testpartialapps.py')'s function which starts with "def test_...():", as running wih the Current File option has issues.

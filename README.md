...
On 12 October 2025 removed Main.js (which seems to be the cause of the incorrect screenshot images issue); ran the second and third page JavaScript files for the desktop web browser Google Chrome directly from the related first page JavaSCript file, which did not encounter incorrect screenshot images for the second and third page JavaScript files' html reports.

...
public class ThirdAndroidAppPractice {

    String capturedScreenshotImageFilepathString = "";
    public ThirdAndroidAppPractice(AndroidDriver driver, ExtentTest extentTest, ExtentSparkReporter extentSparkReporter, ExtentReports extentReport) {
        extentReport.flush();
    }

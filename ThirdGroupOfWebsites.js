...
(async function ThirdGroupOfWebsites() {

    async function takeTheScreenshot() {
        let encodedString = await driver3.takeScreenshot();
        const now = new Date();
    ...
    driver3 = await new Builder().forBrowser(Browser.CHROME).build();
    ...
    driver3.get("https://aminoapps.com/c/maplestorysea/home/");

    let title14 = await driver3.getTitle();
    ...
    let latestTab = await driver3.findElement(By.xpath("//*[contains(text(), 'Latest')]"));
    latestTab.click();

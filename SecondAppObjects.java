...
public class SecondAppObjects {
    ...
    WebElement invokeSearchTab;

    @AndroidFindBy(xpath = "//android.widget.EditText[@resource-id=\"io.appium.android.apis:id/txt_query_prefill\"]")
    WebElement prefillQueryTextField;

    String capturedScreenshotImageFilepathString = "";

    public SecondAppObjects(AndroidDriver driver, ExtentTest extentTest, ExtentSparkReporter extentSparkReporter, ExtentReports extentReport) throws IOException {
        WebElement appTab = driver.findElement(By.xpath("//android.widget.TextView[@content-desc=\"App\"]"));
        ...
        WebElement searchTab = driver.findElement(By.xpath("//android.widget.TextView[@content-desc=\"Search\"]"));
        ...
        WebElement invokeSearchTab = driver.findElement(By.xpath("//android.widget.TextView[@content-desc=\"Invoke Search\"]"));
        ...
        WebElement prefillQueryTextField = driver.findElement(By.xpath("//android.widget.EditText[@resource-id=\"io.appium.android.apis:id/txt_query_prefill\"]"));
        if (prefillQueryTextField.isDisplayed()) {
            capturedScreenshotImageFilepathString = takeScreenshot(driver);
            extentTest.addScreenCaptureFromPath(capturedScreenshotImageFilepathString).pass(MediaEntityBuilder.createScreenCaptureFromPath(capturedScreenshotImageFilepathString).build()).log(Status.PASS, "Before entering the text - Pass.");
            System.out.println("Pass");
        } else {
            capturedScreenshotImageFilepathString = takeScreenshot(driver);
            extentTest.addScreenCaptureFromPath(capturedScreenshotImageFilepathString).pass(MediaEntityBuilder.createScreenCaptureFromPath(capturedScreenshotImageFilepathString).build()).log(Status.FAIL, "Before entering the text - Fail.");

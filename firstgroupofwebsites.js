...
(async function firstGroupOfWebsites() {
    ...
    async function takeTheScreenshot() {
        ...
        let text1 = "C:\\Users\\sohjnthn\\WebstormProjects\\untitled1\\javascript\\JavaScript_Screenshot_Images\\";
        let text2 = formattedDateTime;
        let text3 = text1.concat(" ", text2);
        let text4 = "_image.png";
        await writeFileSync(text3.concat("", text4), encodedString, 'base64');
        ...
        let returnString = "C:\\Users\\sohjnthn\\WebstormProjects\\untitled1\\javascript\\JavaScript_Screenshot_Images\\" + text2 + text4;

...
public class ThirdGroupOfWebsitesPractice {

    String capturedScreenshotImageFilepathString = "";
    public ThirdGroupOfWebsitesPractice(ChromeDriver driver, ExtentTest extentTest, ExtentSparkReporter extentSparkReporter, ExtentReports extentReport) {
        extentReport.flush();
    }

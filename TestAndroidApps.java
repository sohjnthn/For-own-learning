...
public class TestAndroidApps {
    ...
    public void testMethod1() throws IOException {
        ...
        desiredCapabilities.setCapability("appium:app", "C:\\Users\\sohjnthn\\IdeaProjects\\Selenium_Android\\com.afwsamples.testdpc_9.0.12-9012_minAPI21(nodpi)_apkmirror.com.apk");
        desiredCapabilities.setCapability("appium:automationName", "UiAutomator2");
        driver1 = new AndroidDriver(new URL("http://127.0.0.1:4723/wd/hub"), desiredCapabilities);

        //WebElement policyManagementText = driver1.findElement(By.xpath("//android.widget.TextView[@text=\"Policy management\"]"));

        firstAppObjects = new FirstAppObjects(driver1, extentTest, extentSparkReporter, extentReport);

        //if(firstAppObjects.policyManagementText.isDisplayed()){
    ...
    public void testMethod3 () throws IOException {
        ...
        desiredCapabilities.setCapability("platformName", "Android");
        desiredCapabilities.setCapability("appium:platformVersion", "15.0");
        desiredCapabilities.setCapability("appium:app", "C:\\Users\\sohjnthn\\IdeaProjects\\Selenium_Android\\ApiDemos-debug.apk");
        desiredCapabilities.setCapability("appium:automationName", "UiAutomator2");
        ...
        //WebElement appTab = driver2.findElement(By.xpath("//android.widget.TextView[@content-desc=\"App\"]"));

        //if(appTab.isDisplayed()){
            //capturedScreenshotImageFilepathString = takeScreenshot(driver2);
            //extentTest.addScreenCaptureFromPath(capturedScreenshotImageFilepathString).pass(MediaEntityBuilder.createScreenCaptureFromPath(capturedScreenshotImageFilepathString).build()).log(Status.PASS, "App tab is displayed.");
        //} else {
            //capturedScreenshotImageFilepathString = takeScreenshot(driver2);
            //extentTest.addScreenCaptureFromPath(capturedScreenshotImageFilepathString).pass(MediaEntityBuilder.createScreenCaptureFromPath(capturedScreenshotImageFilepathString).build()).log(Status.FAIL, "App tab is not displayed.");
        //}
        //appTab.click();

        //WebElement searchTab = driver2.findElement(By.xpath("//android.widget.TextView[@content-desc=\"Search\"]"));
        //if(searchTab.isDisplayed()){
            //capturedScreenshotImageFilepathString = takeScreenshot(driver2);
            //extentTest.addScreenCaptureFromPath(capturedScreenshotImageFilepathString).pass(MediaEntityBuilder.createScreenCaptureFromPath(capturedScreenshotImageFilepathString).build()).log(Status.PASS, "Search tab is displayed.");
        //} else {
            //capturedScreenshotImageFilepathString = takeScreenshot(driver2);
            //extentTest.addScreenCaptureFromPath(capturedScreenshotImageFilepathString).pass(MediaEntityBuilder.createScreenCaptureFromPath(capturedScreenshotImageFilepathString).build()).log(Status.FAIL, "Search tab is not displayed.");
        //}
        //searchTab.click();

        //WebElement invokeSearchTab = driver2.findElement(By.xpath("//android.widget.TextView[@content-desc=\"Invoke Search\"]"));
        //if(invokeSearchTab.isDisplayed()){
            //capturedScreenshotImageFilepathString = takeScreenshot(driver2);
            //extentTest.addScreenCaptureFromPath(capturedScreenshotImageFilepathString).pass(MediaEntityBuilder.createScreenCaptureFromPath(capturedScreenshotImageFilepathString).build()).log(Status.PASS, "Invoke Search tab is displayed.");
        //} else {
            //capturedScreenshotImageFilepathString = takeScreenshot(driver2);
            //extentTest.addScreenCaptureFromPath(capturedScreenshotImageFilepathString).pass(MediaEntityBuilder.createScreenCaptureFromPath(capturedScreenshotImageFilepathString).build()).log(Status.FAIL, "Invoke Search tab is not displayed.");
        //}
        //invokeSearchTab.click();

        //WebElement prefillQueryTextField = driver2.findElement(By.xpath("//android.widget.EditText[@resource-id=\"io.appium.android.apis:id/txt_query_prefill\"]"));
        //prefillQueryTextField.sendKeys("Test the text.");

        //if(prefillQueryTextField.isDisplayed()){
            //capturedScreenshotImageFilepathString = takeScreenshot(driver2);
            //extentTest.addScreenCaptureFromPath(capturedScreenshotImageFilepathString).pass(MediaEntityBuilder.createScreenCaptureFromPath(capturedScreenshotImageFilepathString).build()).log(Status.PASS, "Able to enter the text \"Test the text.\".");
            //System.out.println("Pass");
        //} else {
            //capturedScreenshotImageFilepathString = takeScreenshot(driver2);
            //extentTest.addScreenCaptureFromPath(capturedScreenshotImageFilepathString).pass(MediaEntityBuilder.createScreenCaptureFromPath(capturedScreenshotImageFilepathString).build()).log(Status.FAIL, "Unable to enter the text \"Test the text.\".");
            //System.out.println("Fail");
        //}
        ...
        desiredCapabilities.setCapability("platformName", "Android");
        desiredCapabilities.setCapability("appium:platformVersion", "15.0");
        desiredCapabilities.setCapability("appium:app", "C:\\Users\\sohjnthn\\IdeaProjects\\Selenium_Android\\com.microsoft.emmx.canary_138.0.3336.0-333600000_minAPI26(armeabi-v7a)(nodpi)_apkmirror.com.apk");
        desiredCapabilities.setCapability("appium:automationName", "UiAutomator2");
        ...
        //WebElement edgeBrowserDefaultWebpageSearchBar = driver3.findElement(By.xpath("//android.widget.EditText[@resource-id=\"com.microsoft.emmx.canary:id/url_bar\"]"));

        //if(edgeBrowserDefaultWebpageSearchBar.isDisplayed()){
            //capturedScreenshotImageFilepathString = takeScreenshot(driver3);
        ...
        // Note, no text was entered, but these two following lines did not cause any error

        //edgeBrowserDefaultWebpageSearchBar.sendKeys("MapleStorySEA Unfunded Amino");
        //edgeBrowserDefaultWebpageSearchBar.sendKeys(Keys.ENTER);

        // So this last screenshot image is the default webpage without any UI changes
